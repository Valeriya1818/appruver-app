            ...
            <div class="card-body pt-4">
                ...
                <div class="timeline timeline-6 mt-3">
                    ...
                    <div class="timeline-item align-items-start">
                        ...
                        <!--end::Badge-->
                        <!--begin::Text-->
                        <div class="font-weight-mormal font-size-lg timeline-content text-muted pl-3">Outlines keep you
                    ...
                    <div class="timeline-item align-items-start">
                        ...
                        <!--end::Badge-->
                        <!--begin::Text-->
                        <div class="timeline-content font-weight-mormal font-size-lg text-muted pl-3">Outlines keep and
        ...
        <div class="card card-custom card-stretch gutter-b">
            ...
            <div class="card-body pt-0">
                ...
                <div class="mb-10">
                    ...
                    <!--end::Section-->
                    <!--begin::Desc-->
                    <p class="text-dark-50 m-0 pt-5 font-weight-normal">A brief write up about the Popular Authors that
